...
class Generator(nn.Module):
    def __init__(self, ngpu):
        ...
        self.main = nn.Sequential(
            """”in_channels(int) – 输入信号的通道数---nz
                out_channels(int) – 卷积产生的通道数---ngf
                kerner_size(int or tuple) - 卷积核的大小---4
                stride(int or tuple,optional) - 卷积步长---1
                padding(int or tuple, optional) - 输入的每一条边补充0的层数---0
